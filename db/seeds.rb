...
u1 = User.create!(username: 'funbucket89', password: 'password', enneagram_id: e8.id, myers_brigg_id: mb11.id)
u2 = User.create!(username: 'yipididoda', password: 'password', enneagram_id: e3.id, myers_brigg_id: mb15.id)
u3 = User.create!(username: 'nathat', password: 'password', enneagram_id: e7.id, myers_brigg_id: mb11.id)
u4 = User.create!(username: 'markymark', password: 'password', enneagram_id: e9.id, myers_brigg_id: mb3.id)
